...
namespace transform_filter_glm {
    ...
    #define CLASS_DECL AbstractTransformForwardBackwardSmoother<SmoothingValueType, TransformFilterType>

    TEMPLATE_DEF CLASS_DECL::~AbstractTransformForwardBackwardSmoother()
    {}
